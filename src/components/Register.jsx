            ...
            <form className="space-y-2">
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center ">
                            <input type="password" placeholder="Confirm password" className="placeholder:text-dark25 w-full bg-white border rounded-md border-gray-300 focus:border-primary text-xs outline-none text-dark25 leading-5 py-1 pl-3 pr-9 duration-300 ease-in-out"/>
                            <img className="absolute right-16" src='/public/assets/icon/pass-show.svg' alt="show password icon"/> {/*Will need to fix the eye icon*/}
                        </div>
                    </div>
                </div>
