const Register = () => (
    ...
    <div className="text-dark bg-neutral50 blur-none rounded-3xl w-[300px] px-12 py-8">{/*Will need to blur or remove it*/}
        <div className="flex-col space-y-2">
            ...
            <form className="space-y-2">
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center ">
                            <input type="password" placeholder="Confirm password" className="placeholder:text-dark25 placeholder:font-light w-full bg-white border rounded-md border-gray-300 focus:border-primary text-xs outline-none text-dark25 leading-5 py-1 pl-3 pr-9 duration-300 ease-in-out"/>
                            <img className="absolute right-16" src='/public/assets/icon/pass-show.svg' alt="show password icon"/> {/*Will need to fix the eye icon*/}
                        </div>
                    </div>
                </div>
                <button className="text-white py-2 px-5 w-full bg-primary hover:bg-accent rounded">Create account</button>
            </form>
            ...
            <a href="#"><p className="flex justify-center text-xs font-semibold">Sign in!</p></a>
        </div>
    </div>
