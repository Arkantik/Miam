    ...
    return (
        ...
        <form className="relative">
            <div className="flex ">
                ...
                <button id="dropdown-button" data-dropdown-toggle="dropdown" className=" flex-shrink-0 inline-flex items-center text-center py-2.5 px-4 text-sm bg-neutral50 dark:bg-dark border border-dark25 dark:border-dark25 hover:bg-dark25 dark:hover:bg-gray-600 rounded-l-lg focus:outline-none " type="button">All categories <svg aria-hidden="true" className="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg></button>
